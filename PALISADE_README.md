...
|--------|-------------|--------|
| **`edge-audit`** | Best-effort exposure triage for edge devices (SonicWall, Fortinet, F5, Cisco, Palo Alto, Ivanti) using non-intrusive fingerprinting plus curated KEV signature matching | 🔨 In Progress |
